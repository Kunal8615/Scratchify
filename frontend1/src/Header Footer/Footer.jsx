        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/exchange" className="text-gray-400 hover:text-purple-400 transition-colors text-sm">
                  Exchange Cards
                </Link>
              </li>
              <li>
                <Link to="/deals" className="text-gray-400 hover:text-purple-400 transition-colors text-sm">
                  Best Deals
                </Link>
              </li>
              <li>
                <Link to="/upload" className="text-gray-400 hover:text-purple-400 transition-colors text-sm">
                  Upload Card
                </Link>
              </li>
              <li>
